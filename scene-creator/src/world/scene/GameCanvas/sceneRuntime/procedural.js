...
function createChunkMeshes(capacity) {
  ...
  const trunkMat = new THREE.MeshStandardMaterial({ color: "#5b3a1f", roughness: 0.95 });
  const crownMat = new THREE.MeshStandardMaterial({ color: "#1f4f1f", roughness: 0.9, flatShading: true });
  const rockMat = new THREE.MeshStandardMaterial({ color: "#7f8084", roughness: 1 });
  const grassMat = new THREE.MeshStandardMaterial({ color: "#58a548", roughness: 1, flatShading: true });
  const pathMat = new THREE.MeshStandardMaterial({ color: "#6f5536", roughness: 1 });
